...
func (mr *MockUserRepositoryMockRecorder) UserLogin(email, password any) *gomock.Call {
...
func (mr *MockUserRepositoryMockRecorder) UserRegister(email, password, role any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
